...
public class MainClass implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        KeyBindingsHandler ignored = KeyBindingsHandler.getInstance();
    ...
    public static void clientTickEventsMethod(MinecraftClient minecraftClient) {
        ...
        if (!MainClass.alreadyDisabledAdvancementKey && minecraftClient.options != null) {
            minecraftClient.options.keyAdvancements.setBoundKey(InputUtil.fromTranslationKey("key.keyboard.unknown"));
