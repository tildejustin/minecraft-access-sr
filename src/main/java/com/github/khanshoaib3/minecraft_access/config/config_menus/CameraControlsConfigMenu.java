    ...
    protected void init() {
        ...
        ButtonWidget featureToggleButton = this.buildButtonWidget("minecraft_access.gui.common.button.feature_toggle_button." + (MainClass.config.getConfigMap().getCameraControlsConfigMap().isEnabled() ? "enabled" : "disabled"),
                (button) -> {
                    ...
                    button.setMessage(new LiteralText(I18n.translate("minecraft_access.gui.common.button.feature_toggle_button." + (MainClass.config.getConfigMap().getCameraControlsConfigMap().isEnabled() ? "enabled" : "disabled"))));
                });
        ...
        ButtonWidget normalRotatingAngleButton = this.buildButtonWidget(
                ...
                (button) -> this.client.openScreen(new ValueEntryMenu("value_entry_menu", ValueEntryMenu.CONFIG_TYPE.CAMERA_CONTROLS_NORMAL_ROTATING_ANGLE, this)));
        this.addButton(normalRotatingAngleButton);
        ...
        ButtonWidget modifiedRotatingAngleButton = this.buildButtonWidget(
                ...
                (button) -> this.client.openScreen(new ValueEntryMenu("value_entry_menu", ValueEntryMenu.CONFIG_TYPE.CAMERA_CONTROLS_MODIFIED_ROTATING_ANGLE, this)));
        this.addButton(modifiedRotatingAngleButton);
        ...
        ButtonWidget delayButton = this.buildButtonWidget(
                ...
                (button) -> this.client.openScreen(new ValueEntryMenu("value_entry_menu", ValueEntryMenu.CONFIG_TYPE.CAMERA_CONTROLS_DELAY, this)));
