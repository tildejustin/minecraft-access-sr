    ...
    protected void init() {
        ...
        ButtonWidget featureToggleButton = this.buildButtonWidget("minecraft_access.gui.common.button.feature_toggle_button." + (MainClass.config.getConfigMap().getFallDetectorConfigMap().isEnabled() ? "enabled" : "disabled"),
                (button) -> {
                    ...
                    button.setMessage(new LiteralText(I18n.translate("minecraft_access.gui.common.button.feature_toggle_button." + (MainClass.config.getConfigMap().getFallDetectorConfigMap().isEnabled() ? "enabled" : "disabled"))));
                });
        ...
        ButtonWidget rangeButton = this.buildButtonWidget(
                ...
                (button) -> this.client.openScreen(new ValueEntryMenu("value_entry_menu", ValueEntryMenu.CONFIG_TYPE.FALL_DETECTOR_RANGE, this)));
        ...
        ButtonWidget depthButton = this.buildButtonWidget(
                ...
                (button) -> this.client.openScreen(new ValueEntryMenu("value_entry_menu", ValueEntryMenu.CONFIG_TYPE.FALL_DETECTOR_DEPTH_THRESHOLD, this)));
        this.addButton(depthButton);
        ...
        ButtonWidget playAlternateSoundButton = this.buildButtonWidget(
                ...
                (button) -> {
                    ...
                    MainClass.config.setConfigMap(configMap);
                    button.setMessage(new LiteralText(I18n.translate("minecraft_access.gui.common.button.toggle_button." + (MainClass.config.getConfigMap().getFallDetectorConfigMap().isPlayAlternateSound() ? "enabled" : "disabled"),
                            I18n.translate("minecraft_access.gui.fall_detector_config_menu.button.play_alternate_sound_button")
                    )));
                });
        playAlternateSoundButton.active = false;
        this.addButton(playAlternateSoundButton);
        ...
        ButtonWidget volumeButton = this.buildButtonWidget(
                ...
                (button) -> this.client.openScreen(new ValueEntryMenu("value_entry_menu", ValueEntryMenu.CONFIG_TYPE.FALL_DETECTOR_VOLUME, this)));
        ...
        ButtonWidget delayButton = this.buildButtonWidget(
                ...
                (button) -> this.client.openScreen(new ValueEntryMenu("value_entry_menu", ValueEntryMenu.CONFIG_TYPE.FALL_DETECTOR_DELAY, this)));
