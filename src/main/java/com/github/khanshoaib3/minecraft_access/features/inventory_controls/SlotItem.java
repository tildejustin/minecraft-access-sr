...
import com.github.khanshoaib3.minecraft_access.mixin.accessor.LoomScreenAccessor;
import com.github.khanshoaib3.minecraft_access.mixin.accessor.MerchantScreenAccessor;
import com.github.khanshoaib3.minecraft_access.mixin.accessor.StonecutterScreenAccessor;
...
//        }
        ...
        if (MinecraftClient.getInstance().currentScreen instanceof MerchantScreen merchantScreen) {
            TraderOfferList tradeOfferList = merchantScreen.getScreenHandler().getRecipes();
