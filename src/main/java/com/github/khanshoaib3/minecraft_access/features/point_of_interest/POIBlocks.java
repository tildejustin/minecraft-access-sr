...
//        Vec3d playerVec3dPos = minecraftClient.player.getEyePos(); // post 1.17
        Vec3d playerVec3dPos = (new Vec3d(minecraftClient.player.getX(), minecraftClient.player.getEyeY(), minecraftClient.player.getZ())); // pre 1.17
...
//            MainClass.speakWithNarrator(I18n.translate("narrate.apextended.poiblock.warn"), true);
        ...
        if (this.playSound && this.volume > 0 && !soundType.isEmpty()) {
            ...
            if (soundType.equalsIgnoreCase("ore"))
                ...
                minecraftClient.world.playSound(minecraftClient.player, new BlockPos(blockVec3dPos), SoundEvents.BLOCK_NOTE_BLOCK_BIT,
                        SoundCategory.BLOCKS, volume, 2f);
            else //noinspection ConstantValue
                if (this.playSoundForOtherBlocks && soundType.equalsIgnoreCase("blocksWithInterface"))
                    minecraftClient.world.playSound(minecraftClient.player, new BlockPos(blockVec3dPos), SoundEvents.BLOCK_NOTE_BLOCK_BANJO,
