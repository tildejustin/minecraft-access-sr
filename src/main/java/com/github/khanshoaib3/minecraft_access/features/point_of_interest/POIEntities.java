            ...
            for (Entity i : minecraftClient.world.getEntities()) {
                ...
                if (markedEntity.test(i)) {
                    ...
                    if (i instanceof HostileEntity) {
                        this.playSoundAtBlockPos(minecraftClient, blockPos, SoundEvents.BLOCK_NOTE_BLOCK_BELL, 2f);
                    } else {
                        this.playSoundAtBlockPos(minecraftClient, blockPos, SoundEvents.BLOCK_NOTE_BLOCK_BELL, 0f);
                    }
                }
