...
public class KeyBindingsHandler {
    ...
    private void initializeInventoryControlsKeybindings() {
        ...
        KeyBindingHelper.registerKeyBinding(inventoryControlsGroupKey);
        ...
        KeyBindingHelper.registerKeyBinding(inventoryControlsLeftMouseClickKey);
        ...
        KeyBindingHelper.registerKeyBinding(inventoryControlsRightMouseClickKey);
        ...
        KeyBindingHelper.registerKeyBinding(inventoryControlsUpKey);
        ...
        KeyBindingHelper.registerKeyBinding(inventoryControlsRightKey);
        ...
        KeyBindingHelper.registerKeyBinding(inventoryControlsDownKey);
        ...
        KeyBindingHelper.registerKeyBinding(inventoryControlsLeftKey);
        ...
        KeyBindingHelper.registerKeyBinding(inventoryControlsSwitchTabKey);
        ...
        KeyBindingHelper.registerKeyBinding(inventoryControlsToggleCraftableKey);
    }
    ...
    private void initializeCameraControlsKeybindings() {
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsUp);
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsRight);
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsDown);
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsLeft);
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsAlternateUp);
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsAlternateRight);
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsAlternateDown);
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsAlternateLeft);
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsNorth);
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsEast);
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsWest);
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsSouth);
        ...
        KeyBindingHelper.registerKeyBinding(cameraControlsCenterCamera);
    }
    ...
    private void initializeMouseSimulationKeybindings() {
        ...
        KeyBindingHelper.registerKeyBinding(mouseSimulationLeftMouseKey);
        ...
        KeyBindingHelper.registerKeyBinding(mouseSimulationRightMouseKey);
        ...
        KeyBindingHelper.registerKeyBinding(mouseSimulationMiddleMouseKey);
        ...
        KeyBindingHelper.registerKeyBinding(mouseSimulationScrollUpKey);
        ...
        KeyBindingHelper.registerKeyBinding(mouseSimulationScrollDownKey);
    }
    ...
    private void initializeOtherKeybindings() {
        ...
        KeyBindingHelper.registerKeyBinding(healthNHungerNarrationKey);
        ...
        KeyBindingHelper.registerKeyBinding(lockingHandlerKey);
        ...
        KeyBindingHelper.registerKeyBinding(positionNarrationKey);
        ...
        KeyBindingHelper.registerKeyBinding(narratorMenuKey);
        ...
        KeyBindingHelper.registerKeyBinding(narratorMenuHotKey);
        ...
        KeyBindingHelper.registerKeyBinding(directionNarrationKey);
    }
